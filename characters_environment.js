...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Move your nose anywhere hopefully not down, for your sake😎 ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
  ...
  if(gameConfig.status==='gameover'){
    ...
    textSize(15);
    text("Press SPACE to Restart, you failed. Better luck next time😅", gameConfig.screenX/2, gameConfig.screenY/2+135);
    textSize(40);
